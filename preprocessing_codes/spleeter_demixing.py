...
class prepare_spectrgram_data(object):
    def __init__(self):
        ...
        np.savez_compressed('/data1/zhaojw/dataset/linear_spectrogram_data_11k', ballroom=ballroom_data,\
        ...
        #np.savez_compressed('/data1/zhaojw/dataset/beat_annotation', ballroom=ballroom_annotation,\
